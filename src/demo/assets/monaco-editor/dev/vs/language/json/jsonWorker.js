...
define("vs/language/json/jsonWorker", ["require"], (require) => {
  ...
  var moduleExports = (() => {
    ...
    function createScanner(text, ignoreTrivia) {
      ...
      function scanDataSource() {
        ...
        while (true) {
          ...
          var ch = text.charCodeAt(pos);
          if (ch === 125) {
            result += text.substring(start+1, pos-1);
            pos++;
            break;
          }
          pos++;
      ...
      function scanNext() {
        ...
        switch (code) {
          case 36: //FLOWX-UPGRADE
            if (text.charCodeAt(pos + 1) == 123) {
              pos++;
              value = scanDataSource();
              return (token = 18);
            } else {
              pos++;
              return (token = 16);
            }
          case 123: //FLOWX-UPGRADE
            if (text.charCodeAt(pos - 1) == 36) {
              pos++;
              return (token = 18);
            } else {
              pos++;
    ...
    (function (SymbolKind2) {
      ...
      SymbolKind2.FlowxDatasource = 27; //FLOWX-UPGRADE
    ...
    //FLOWX-UPGRADE
    var DataSourceASTNodeImpl =
      /** @class */
      (function (_super) {
        __extends(DataSourceASTNodeImpl2, _super);
        function DataSourceASTNodeImpl2(parent, datasourceValue, offset) {
          var _this =
            _super.call(this, parent, datasourceValue, offset) || this;
          _this.type = "datasource";
          _this.value = datasourceValue;
          return _this;
        }
        return DataSourceASTNodeImpl2;
      })(ASTNodeImpl);
    ...
    function parse3(textDocument, config) {
      ...
      //FLOWX-UPGRADE
      function _parseDataModel(parent) {
        if (scanner.getToken() !== 18) {
          return void 0;
        }
        var node;
        var node = new DataSourceASTNodeImpl(
          parent,
          "",
          scanner.getTokenOffset()
        );
                ...
                if (schemaPropertyNames_1.enum) {
                  for (var i = 0; i < schemaPropertyNames_1.enum.length; i++) {
                    ...
                    if (
                      ...
                      enumDescription =
                        schemaPropertyNames_1.enumDescriptions[i];
                    }
      ...
      (function () {
        ...
        JSONDocumentSymbols2.prototype.getSymbolKind = function (nodeType) {
          switch (nodeType) {
            ...
            case "datasource":
              return SymbolKind.FlowxDatasource;
            default:
